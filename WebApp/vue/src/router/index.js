...
import sharedlockersRouter from './modules/sharedlockers'
...
export const asyncRoutes = [{
  ...
  children: [{
    ...
    path: 'wechatApp',
    component: () => import('@/views/wechat-app/index'),
    name: 'WechatApp',
    meta: {
      title: 'wechatApp',
      icon: 'apps'
...
},
{
  ...
  meta: {
    ...
    icon: 'system',
    roles: ['BaseService.AuditLogging', 'AbpIdentity.Users', 'AbpIdentity.Roles', 'BaseService.Organization', 'BaseService.DataDictionary', 'BaseService.Job'],
  },
  children: [{
    path: 'user',
