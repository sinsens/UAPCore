...
namespace AuthServer.Host
{
    public class AuthServerDataSeeder : IDataSeedContributor, ITransientDependency
    {
        ...
        private async Task CreateApiScopesAsync()
        {
			...
			await CreateApiScopeAsync("SharedLockerService");
        }
        ...
        private async Task CreateApiResourcesAsync()
        {
            var commonApiUserClaims = new[]
            {
                ...
                AbpClaimTypes.ImpersonatorTenantName,
                AbpClaimTypes.ImpersonatorTenantId,
                AbpClaimTypes.ImpersonatorUserId,
                AbpClaimTypes.ImpersonatorUserName
            };
            ...
            await CreateApiResourceAsync("SharedLockerService", commonApiUserClaims);
        }
        ...
        private async Task CreateClientsAsync()
        {
            ...
            await CreateClientAsync(
                name: "basic-web",
                scopes: new[] { "BaseService", "WebAppGateway", "BusinessService", "SharedLockerService" },
