...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"slocker","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 5 */
/*!*********************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/pages.json ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 9 */
/*!***************************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/static/config.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _envDev = _interopRequireDefault(__webpack_require__(/*! ./env.dev.js */ 10));
var _envProd = _interopRequireDefault(__webpack_require__(/*! ./env.prod.js */ 11));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
/* 10 */
/*!****************************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/static/env.dev.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ENV: 'development',
  APP_ID: 'wxbc58f53cd1930743',
  APP_BASE_API: 'http://localhost:62162',
  APP_AUTHSERVER_API: 'http://localhost:53362',
  APP_STORAGE_API: 'http://localhost:59958' };exports.default = _default;

/***/ }),
/* 11 */
/*!*****************************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/static/env.prod.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 15 */
/*!**************************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/locale/index.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 16));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 17));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 18));
var _ja = _interopRequireDefault(__webpack_require__(/*! ./ja.json */ 19));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  en: _en.default,
...
var store = new _vuex.default.Store({
  state: { //存放状态
    userid: uni.getStorageSync("".concat(key, "_userid")),
    tenantid: uni.getStorageSync("".concat(key, "_tenantid")),
    appid: uni.getStorageSync("".concat(key, "_appid")),
    token: uni.getStorageSync("".concat(key, "_token")),
    hasLogin: uni.getStorageSync("".concat(key, "_haslogin")),
    name: uni.getStorageSync("".concat(key, "_name")),
    phone: uni.getStorageSync("".concat(key, "_phone")),
    lang: uni.getStorageSync("".concat(key, "_lang")) || 'zh-Hans' },

  mutations: {
    setUserId: function setUserId(state, userid) {
      state.userid = userid;
      uni.setStorageSync("".concat(key, "_userid"), userid);
    },
    setTenantId: function setTenantId(state, tenantid) {
      state.tenantid = tenantid;
      uni.setStorageSync("".concat(key, "_tenantid"), tenantid);
    },
    setAppId: function setAppId(state, appid) {
      state.appid = appid;
      uni.setStorageSync("".concat(key, "_appid"), appid);
    },
    setToken: function setToken(state, token) {
      state.token = token;
      state.hasLogin = token && token.length > 0;
      uni.setStorageSync("".concat(key, "_token"), token);
      uni.setStorageSync("".concat(key, "_haslogin"), state.hasLogin);
    },
    setProfile: function setProfile(state, param) {
      state.name = param.name;
      state.phone = param.phone;
      uni.setStorageSync("".concat(key, "_name"), param.name);
      uni.setStorageSync("".concat(key, "_phone"), param.phone);
    },
    setLang: function setLang(state, lang) {
      state.lang = lang;
      uni.setStorageSync("".concat(key, "_lang"), lang);
    } } });var _default =
...
/* 51 */
/*!*************************************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/pages.json?{"type":"stat"} ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__3409905" };exports.default = _default;
...
/* 60 */
/*!**********************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/api/user.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.login = login;exports.updateNameAndPhone = updateNameAndPhone;var _config = _interopRequireDefault(__webpack_require__(/*! @/static/config.js */ 9));
var _index = _interopRequireDefault(__webpack_require__(/*! @/store/index.js */ 20));
var _request = __webpack_require__(/*! @/utils/request.js */ 61);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
    ...
    success: function success(res) {
      ...
      uni.login({
        ...
        success: function success(loginRes) {
          ...
          (0, _request.post)('/api/wechat-management/mini-programs/login/login', loginInfo).then(
          function (res) {
            console.log('登录调用成功！');
            console.log(res);
            var rawData = JSON.parse(res.rawData);
            console.log(rawData);
            _index.default.commit('setUserId', res.userId);
            _index.default.commit('setAppId', res.appId);
            _index.default.commit('setTenantId', res.tenantId);
            _index.default.commit('setToken', rawData.access_token);
            uni.reLaunch({
...
{var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { id: '', name: '', phone: '', phoneIsConfirm: false };
  console.log('options', options);
  return (0, _request.put)("/api/wechat-management/mini-programs/user-info/updateNameAndPhone/".concat(options.id), options).then(function (res) {
    console.log('更新成功');
  });
}
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/* 61 */
/*!***************************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/utils/request.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.post = post;exports.get = get;exports.put = put;exports.default = void 0;var _config = _interopRequireDefault(__webpack_require__(/*! ../static/config.js */ 9));
var _index = _interopRequireDefault(__webpack_require__(/*! @/store/index.js */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
function service() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  _index.default.state.appid && (appid = _index.default.state.appid);
  _index.default.state.token && (token = _index.default.state.token);
  _index.default.state.userid && (userid = _index.default.state.userid);
  _index.default.state.tenantid && (tenantid = _index.default.state.tenantid);

  options.url = "".concat(_config.default.APP_BASE_API).concat(options.url);
  options.header = {
    'content-type': 'application/json',
    'Authorization': "Bearer ".concat(token),
    'uap_appid': "".concat(appid),
    '__tenant': tenantid,
    'uap_userid': userid };
...
/* 75 */
/*!***************************************************************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/uni_modules/no-data/components/no-data/i18n/index.js ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 76));
...
var _ja = _interopRequireDefault(__webpack_require__(/*! ./ja.json */ 79));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  en: _en.default,
  'zh-Hans': _zhHans.default,
  'zh-Hant': _zhHant.default,
...
/* 76 */
/*!**************************************************************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/uni_modules/no-data/components/no-data/i18n/en.json ***!
  \**************************************************************************************************************/
...
/* 77 */
/*!*******************************************************************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/uni_modules/no-data/components/no-data/i18n/zh-Hans.json ***!
  \*******************************************************************************************************************/
/*! exports provided: no-data.title, default */
/***/ (function(module) {
...
/* 78 */
/*!*******************************************************************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/uni_modules/no-data/components/no-data/i18n/zh-Hant.json ***!
  \*******************************************************************************************************************/
/*! exports provided: no-data.title, default */
/***/ (function(module) {
...
/* 79 */
/*!**************************************************************************************************************!*\
  !*** G:/github/sinsens/ABP-MicroService/MiniApp/slocker/uni_modules/no-data/components/no-data/i18n/ja.json ***!
  \**************************************************************************************************************/
/*! exports provided: no-data.title, default */
/***/ (function(module) {
